...
/>
  ...
  >
    <span className="text-black dark:text-white">حالة الحساب: الكل</span>
  </button>
  ...
  <button
    ...
    style={{ backgroundColor: "#137FEC1A" }}
  >
    <span className="text-black dark:text-white">تاريخ التسجيل</span>
  </button>
</div>
...
>
        ...
        <td className="p-4 text-slate-500">john.doe@example.com</td>
