...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className={`flex min-h-screen font-sans transition-colors duration-300 ${bgColor}`} dir="rtl">
      <AdminSidebar />
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-10">
          <h2 className={`text-2xl font-bold ${mainTextColor}`}>
           إدارة المستخدمين / 
            <span className={dark ? "text-white" : "text-[#137FEC]"}> الملف الشخصي </span>
            <span className="mr-2 text-blue-500 font-extrabold">John Doe</span>
          </h2>
        </div>
