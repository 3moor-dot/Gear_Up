    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl bg-[#F8FBFF] dark:bg-[#0B1020] rounded-[32px] shadow-2xl overflow-hidden border border-[#dbeafe] dark:border-white/10 animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
        <button
          type="button"
          onClick={closeModal}
          className="absolute top-5 left-5 text-gray-500 hover:text-red-500 transition-colors z-10"
        >
          <MdClose size={28} />
        </button>
        ...
        <div className="px-6 md:px-10 py-8 md:py-10">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm md:text-base text-gray-500 dark:text-gray-300">
              اختار الميكانيكي والخدمة والسيارة وحدد الموعد المناسب
            </p>
          </div>
              ...
              <div className="text-right">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`${inputStyle} custom-date-input pr-4 pl-12 text-center md:text-right`}
                    dir="rtl"
                  />
              ...
              <div className="text-right">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`${inputStyle} custom-time-input pr-4 pl-12 text-center md:text-right`}
                    dir="rtl"
                  />
            ...
            <div className="pt-4">
              ...
              >
                <button
                  ...
                  onClick={closeModal}
                  disabled={loading}
                  className="sm:min-w-[160px] bg-white dark:bg-[#111827] text-gray-700 dark:text-white px-8 py-3.5 rounded-2xl font-black text-base border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-[#1f2937] transition-all disabled:opacity-60"
                >
                  إلغاء
                </button>
                ...
                <button
                  ...
                  disabled={loading}
                  className="sm:min-w-[220px] bg-[#137FEC] text-white px-8 py-3.5 rounded-2xl font-black text-base shadow-lg hover:bg-blue-600 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-60 disabled:hover:scale-100"
                >
