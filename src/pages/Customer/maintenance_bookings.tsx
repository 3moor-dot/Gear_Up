...
const MaintenanceBookings = () => {
    // بيانات الحجوزات التجريبية بناءً على الصورة
    const bookings = [
        {
            id: 1,
            mechanic: "علي جمال",
        ...
        },
        {
            ...
            actions: true // لإظهار أزرار الإلغاء والتعديل
        },
        {
            id: 3,
            mechanic: "علي جمال",
                ...
                <main className="p-4 md:p-8 space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="text-right">
                            ...
                            <p className="text-[#0F132380] text-sm">تتبع أعمال الصيانة والإصلاحات والتكاليف الخاصة بسيارتك</p>
                        </div>
                        <button className="bg-[#137FEC] text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:bg-blue-600 transition-all flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                        {bookings.map((booking) => (
                            <div key={booking.id} className="relative">
                                <div className={`bg-[#137FEC4D] dark:bg-[#137FEC33] rounded-2xl p-6 border-r-[6px] ${booking.borderColor} shadow-sm flex flex-col gap-4`}>

                                    {/* السطر العلوي: البيانات على اليمين والحالة على اليسار */}
                                    <div className="flex justify-between items-start w-full">
                                        ...
                                        <div className="grid grid-cols-2 gap-x-12 gap-y-4 text-right">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <p className="font-bold text-white truncate">{booking.mechanic}</p>
                                            </div>

                                            {/* الخدمة */}
                                            <div className="flex items-center gap-2">
                                                <p className="text-[#137FEC] font-bold text-sm shrink-0">الخدمة:</p>
                                                <p className="font-bold text-white truncate">{booking.service}</p>
                                            </div>
                                    ...
                                    {/* السطر السفلي: الأزرار في المنتصف (تظهر فقط عند الحاجة) */}
                                    {booking.actions && (
