...
const translateError = (msg: string): string => {
  const errorMap: Record<string, string> = {
    "User.EmailAlreadyExists":    "البريد الإلكتروني مستخدم بالفعل، جرب بريداً آخر",
    "User.PhoneAlreadyExists":    "رقم الهاتف مستخدم بالفعل، جرب رقماً آخر",
    "User.InvalidCredentials":    "بيانات غير صحيحة",
    "User.NotFound":              "المستخدم غير موجود",
    "User.AlreadyExists":         "الحساب موجود بالفعل",
    "User.InvalidEmail":          "البريد الإلكتروني غير صحيح",
    "User.WeakPassword":          "كلمة المرور ضعيفة جداً",
  };
  ...
  const handleNext = () => {
    ...
    if (Object.keys(errs).length > 0) {
      ...
      Swal.fire({
        ...
        text: "يرجى التحقق من الحقول المطلوبة",
